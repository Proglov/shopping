...
export default function PopularCropsComponent({ src, number, name, href }) {
    return (
        <Link href={href}>
            <div
                className='flex justify-between align-middle m-2 sm:text-xs lg:text-base rounded-xl'
                style={{
                ...
                <div> <Image src={src} alt='Popular Product' width={200} height={300} style={{ borderTopLeftRadius: '0.75rem', borderBottomLeftRadius: '0.75rem' }} /></div>
            </div>
        </Link>
    )
}