    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
            ...
            <AppBar sx={{ zIndex: '200', direction: 'ltr' }}>
                <Toolbar>
                    ...
                    <Typography
                        ...
                        noWrap
                        component="div"
                        sx={{ flexGrow: 1, maxWidth: '48px', flexBasis: '48px', height: '50px', paddingTop: '10px' }}
                    >
                    ...
                    {/* جست و جو */}
                    <Search dir='rtl' sx={{ flexGrow: 0, flexBasis: 'auto', maxWidth: '200px' }}>
                        <SearchIconWrapper>
                            <SearchIcon />
                        </SearchIconWrapper>
                        <StyledInputBase
            ...
            <Menu
                ...
                sx={{ marginTop: '35px' }}
            >
                <MenuItem sx={{ padding: '10px' }} onClick={handleMenuClose}>پروفایل من</MenuItem>
            </Menu>
        </Box>
    );
}
