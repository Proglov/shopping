...
export default function Wheel(props) {
    ...
    return (
        ...
        >
            <div
                className="wheel__shadow-top rounded-sm"
                style={{
            ...
            <div className="wheel__inner">
                <div className="wheel__slides" style={{ width: props.width + "px" }}>
                    {slideValues().map(({ style, value }, idx) => (
                        <div className={`wheel__slide ${idx < props?.shouldBeGray && 'text-gray-400'}`} style={style} key={idx}>
                            <span>{value}</span>
                        </div>
                    ))}
                </div>
            ...
            <div
                className="wheel__shadow-bottom rounded-sm"
                style={{
                    transform: `translateZ(${radius}px)`,
                    WebkitTransform: `translateZ(${radius}px)`,
