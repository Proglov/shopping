...
import { setIsModalDeleteOpen, setSelectedItem, setOperatingError } from '../../redux/reducers/discounts/companyCouponForSomeProducts';
import { deleteCompanyCouponForSomeProductsFromServer } from '../../redux/globalAsyncThunks';
...
export default function ModalDelete() {
    ...
    const deleteItem = async () => {
        try {
            dispatch(deleteCompanyCouponForSomeProductsFromServer(selectedItem?._id))
            dispatch(setSelectedItem({}));
        } catch (error) {
